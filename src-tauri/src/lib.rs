...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            gemini_cli::send_gemini_cli_message,
            ...
            git::revert_git_all,
            git::commit_git,
            git::commit_git_detailed,
            git::push_git,
            git::push_git_detailed,
            git::pull_git,
            git::pull_git_detailed,
            git::fetch_git,
            git::fetch_git_detailed,
            git::sync_git,
            ...
            workspaces::search_workspace_files,
            workspaces::create_workspace_file,
            workspaces::create_workspace_dir,
            workspaces::delete_workspace_path,
            workspaces::move_workspace_path,
