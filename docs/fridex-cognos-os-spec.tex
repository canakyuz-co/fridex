...
% XeLaTeX/Tectonic preview needs Unicode-capable fonts for Turkish characters.
% Use Latin Modern OpenType fonts shipped with TeX distributions (no OS font dependency).
\usepackage{fontspec}
...
% NOTE: Default LaTeX fonts (Latin Modern via lmodern) are used for maximum compatibility.
...
% --- BRAND PALETTE ---
% Avoid underscores in color names (underscore triggers "Missing $ inserted" in text mode).
\definecolor{fridexCyan}{RGB}{0, 191, 255}
\definecolor{fridexNavy}{RGB}{10, 20, 30}
\definecolor{mathBg}{RGB}{245, 252, 255}

% --- TITLES ---
\titleformat{\chapter}[display]
  {\normalfont\bfseries\color{fridexCyan}}
  {\filleft\Huge\thechapter}
  {1ex}
  {\titlerule\vspace{1ex}\filleft\Huge}

\titleformat{\section}{\color{fridexCyan}\Large\bfseries}{\thesection}{1em}{}[\titlerule]
\titleformat{\subsection}{\color{fridexCyan!70!black}\large\bfseries}{\thesubsection}{1em}{}
...
\pagestyle{fancy}
\fancyhf{}
\lhead{\textcolor{fridexCyan}{Fridex / FridayX Kanonik Spesifikasyon}}
\rhead{\thepage}
...
\begin{titlepage}
  \centering
  \vspace*{3cm}
  {\Huge \textbf{\textcolor{fridexCyan}{FRIDEX}}} \\
  \vspace{0.5cm}
  ...
  \vspace{2cm}
  \begin{tcolorbox}[colback=fridexNavy, colframe=fridexNavy, arc=0mm]
