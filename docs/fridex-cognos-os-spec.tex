...
% Keep fonts portable across engines/bundles used by FridayX preview.
% Avoid `fontspec` here: it depends on system font discovery and can fail in sandboxed/bundled engines.
